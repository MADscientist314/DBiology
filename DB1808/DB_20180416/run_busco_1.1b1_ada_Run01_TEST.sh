...
#BSUB -o /scratch/user/jochum00/DBiology/DB1808_20180416.data/BuscoRun01.stdout.%J
#BSUB -e /scratch/user/jochum00/DBiology/DB1808_20180416.data/BuscoRun01.stderr.%J
