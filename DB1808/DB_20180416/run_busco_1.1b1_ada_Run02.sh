...
#BSUB -o /scratch/user/jochum00/DBiology/DB1808_20180413.data/BuscoRun02.stdout.%J
#BSUB -e /scratch/user/jochum00/DBiology/DB1808_20180413.data/BuscoRun02.stderr.%J
