...
pe_1='/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/xellus/xellus2concatR1.fastq'
pe_2='/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/xellus/xellus2concatR2.fastq'
...
hisat2 --dta -p $threads --rg-id "$id" --rg "LB:$library" --rg "SM:$sample" --rg "PL:$platform" -x $genome_index_prefix -q -1 $pe_1 -2 $pe_2 -S xellus2.sam

samtools view -bS xellus2.sam | samtools sort -m 2G -@ $threads - -T $sample -o $output_bam
