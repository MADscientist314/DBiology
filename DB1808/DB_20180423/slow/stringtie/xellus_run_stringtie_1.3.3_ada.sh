...
label2='xellus2'
label3='xellus3'
out_gtf1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/xellus/${label1}_out.gtf"
out_gtf2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/xellus/${label2}_out.gtf"
out_gtf3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/xellus/${label3}_out.gtf"
################################################################################
#
