...
label2='brach2'
label3='brach3'
out_gtf1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/brach/${label1}_out.gtf"
out_gtf2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/brach/${label2}_out.gtf"
out_gtf3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/slow/brach/${label3}_out.gtf"
################################################################################
#
