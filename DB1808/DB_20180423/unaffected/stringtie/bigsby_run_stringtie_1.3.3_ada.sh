...
label2='bigsby2'
label3='bigsby3'
out_gtf1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/bigsby/${label1}_out.gtf"
out_gtf2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/bigsby/${label2}_out.gtf"
out_gtf3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/bigsby/${label3}_out.gtf"
################################################################################
#
