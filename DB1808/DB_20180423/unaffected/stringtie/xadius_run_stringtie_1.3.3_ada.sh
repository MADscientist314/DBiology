...
bam_file1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/xadius/xadius1_pe_aln.bam"
bam_file2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/xadius/xadius2_pe_aln.bam"
bam_file3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/xadius/xadius3_pe_aln.bam"
label1='xadius1'
label2='xadius2'
label3='xadius3'
out_gtf1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/xadius/${label1}_out.gtf"
out_gtf2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/xadius/${label2}_out.gtf"
out_gtf3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/unaffected/xadius/${label3}_out.gtf"
################################################################################
#
