...
label2='xerdo2'
label3='xerdo3'
out_gtf1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/xerdo/${label1}_out.gtf"
out_gtf2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/xerdo/${label2}_out.gtf"
out_gtf3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/xerdo/${label3}_out.gtf"
