...
bam_file1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/czar/czar1_pe_aln.bam"
bam_file2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/czar/czar2_pe_aln.bam"
bam_file3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/czar/czar3_pe_aln.bam"
label1='czar1'
label2='czar2'
label3='czar3'
out_gtf1="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/czar/${label1}_out.gtf"
out_gtf2="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/czar/${label2}_out.gtf"
out_gtf3="/scratch/user/jochum00/DBiology/DB1808_20180423.data/fast/czar/${label3}_out.gtf"
